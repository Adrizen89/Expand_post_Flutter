        ...
        children: <Widget>[
          Padding(
            ...
            child: ExpansionTileCard(
              ...
              title: Text('Adrien Berard', style: TextStyle(color: Color(0xff03989E)),),
              subtitle: Text('Documentation Flutter', style: TextStyle(color: Color(0xff03989E)),),
              children: <Widget>[
                Divider(
                  thickness: 1.0,
                  height: 1.0,
                ...
                ButtonBar(
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                      ...
                      child: Column(
                        children: <Widget>[
                          Icon(Icons.comment_outlined, color: Color(0xff03989E)),
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 2.0),
                          ),
                        ],
                    ...
                    TextButton(
                      ...
                      child: Column(
                        children: <Widget>[
                          Icon(Icons.ios_share_outlined, color: Color(0xff03989E),),
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 2.0),
                          ),
                        ],
